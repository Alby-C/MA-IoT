...
public class MyDataBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        Log.i(TAG, "Tabella angolo di piega creata");
        db.execSQL("CREATE TABLE Accelerazione(_id INTEGER PRIMARY KEY AUTOINCREMENT, Accelerazione FLOAT, TimeStamp LONG)");
        Log.i(TAG, "Tabella acc creata");
        db.execSQL("CREATE TABLE Accelerazione_Lineare(_id INTEGER PRIMARY KEY AUTOINCREMENT, Accelerazione_Lineare FLOAT, TimeStamp LONG)");
        Log.i(TAG, "Tabella acc creata");
