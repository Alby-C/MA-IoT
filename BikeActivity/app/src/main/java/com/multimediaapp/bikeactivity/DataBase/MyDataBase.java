...
public class MyDataBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        db.execSQL("CREATE TABLE Accelerazione(_id INTEGER PRIMARY KEY AUTOINCREMENT, " +
                "AccelerazioneX FLOAT,/* AccelerazioneY FLOAT , AccelerazioneZ FLOAT,*/ TimeStamp LONG)");
        Log.i(TAG, "Tabella acc creata");
        db.execSQL("CREATE TABLE Sessioni(_id INTEGER PRIMARY KEY AUTOINCREMENT," +
                "Velocità_Max FLOAT,Velocità_Media FLOAT, Angolo_Dx FLOAT, Angolo_Sx FLOAT, Tempo_Tot STRING)");
